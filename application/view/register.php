<div id="main-page">
	<div class="scroller-content full-window-height">
		<div class="container" id="login-panel">
			...
			<form action="./index.php?c=user&amp;m=add" method="post" class="ajax-action-handled-form styled padded-vertical">
				...
				<a href="./index.php?c=user&amp;m=login" data-activate="login_page" class="ajax-handled-anchor non-active">Have an account?</a>
			</form>
		</div>
